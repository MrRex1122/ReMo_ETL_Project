...
DEFAULT_FAMILY_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "terminal_block": {
        ...
        "default_branches": ["клеммные блоки зажимов на din-рейку"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            "priority": 56,
            "positive_patterns": ["клеммный блок", "клеммные блоки", "клеммник", "клемма наборная", "terminal block", "din rail"],
...
DEFAULT_DOMAIN_REGISTRY: Dict[str, Any] = {
    "domains": {
        ...
        "terminal_block": {
            "patterns": ["клеммный блок", "клеммные блоки", "клеммник", "клемма наборная", "terminal block", "din rail"],
