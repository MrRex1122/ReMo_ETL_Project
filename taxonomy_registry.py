...
DEFAULT_FAMILY_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "lighting_fixture": {
        ...
        "default_branches": ["свет > светильники", "люстры под лампу"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "weak_match_policy": "reject_in_exact",
        "classifier": {
    ...
    "workwear": {
        ...
        "default_branches": ["костюмы летние", "костюмы утепленные", "брюки, полукомбинезоны", "куртки утепленные"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["костюм", "suit", "полукомбинез", "брюк", "куртк", "jacket", "overall", "workwear"], ["летн", "утеплен", "рабоч", "workwear"]],
        },
    },
    "safety_footwear": {
    ...
    "sewer_fitting": {
        ...
        "default_branches": ["фитинги для наружной канализации", "фитинги для внутренней канализации"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
    ...
    "auto_repair_tool": {
        ...
        "classifier": {
            ...
            "required_any_tokens": [["авторемонт", "домкрат", "вакуумметр", "ареометр", "маслосбор", "башмак"], ["инструмент", "tool", "адаптер", "шприц", "ванна"]],
        },
    },
    "torx_bit": {
    ...
    "self_tapping_screw": {
        ...
        "default_branches": ["саморезы универсальные", "саморезы гипсокартон-дерево"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
...
DEFAULT_DOMAIN_REGISTRY: Dict[str, Any] = {
    "domains": {
        ...
        "sewer_fitting": {
            "patterns": ["фитинги для наружной канализации", "фитинги для внутренней канализации", "канализационный фитинг", "sewer fitting", "drain fitting"],
        ...
        "workwear": {
            "patterns": ["костюм летний", "костюмы летние", "костюм утепленный", "костюмы утепленные", "полукомбинезон рабочий", "брюки рабочие", "куртка утепленная", "куртки утепленные", "workwear suit", "workwear jacket", "workwear overall"],
            "families": ["workwear"],
        },
        "safety_footwear": {
        ...
        "self_tapping_screw": {
            "patterns": ["саморез универсальный", "саморезы универсальные", "универсальный саморез", "универсальные саморезы", "саморез гипсокартон-дерево", "саморезы гипсокартон-дерево", "саморез для гипсокартона", "drywall screw", "self-tapping screw", "self tapping screw"],
        ...
        "distribution_enclosure": {
            "patterns": ["щит распредел", "силовой щит", "щит с монтажной панелью", "щит этажный", "щиток", "электрощит", "корпус распредел", "корпус учетно", "корпус для модульных устройств", "корпус мультимедиа", "бокс модульный", "встраиваемый щит", "навесной щит", "щрв", "щрн", "щурв", "щурн"],
