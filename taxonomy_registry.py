...
DEFAULT_FAMILY_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "switch_wiring": {
        ...
        "default_branches": [
            ...
            "светорегуляторы (диммеры) скрытого монтажа",
    ...
    "monitor": {
        ...
        "classifier": {
            ...
            "negative_patterns": [
                "мониторинг", "мониторинга", "мониторинговая", "мониторная", "мониторн",
                "snmp", "карта сетевого",
                "для мониторов", "для монитора", "для ноутбука/монитора",
                "до 2 мониторов", "до 4 мониторов", "до 6 мониторов", "до 8 мониторов",
                "рабочее место", "рабочего места", "арм ",
                "кронштейн", "подставка", "рамка", "гарнитура", "аудио",
                "программное обеспечение", "набор для", "урм-орион", "орион про",
            ],
        },
    },
    "lighting_fixture": {
    ...
    "warehouse_cart_part": {
        "entity_types": ["warehouse_cart_part"],
        "default_branches": ["запчасти для складских тележек"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "negative_patterns": ["офисное кресло", "чемодан", "садовая тачка", "кабельная тележка"],
            "required_any_tokens": [["тележ", "trolley", "cart", "caster"], ["колес", "ролик", "опор", "wheel"]],
        },
    },
    "crane_equipment_accessory": {
        "entity_types": ["crane_equipment_accessory"],
        "default_branches": ["вспомогательные элементы и аксессуары двигателей и кранового оборудования"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "negative_patterns": ["электродвигатель общепромышленный", "насос", "преобразователь частоты", "редуктор"],
            "required_any_tokens": [
                ["катушк", "колодк", "тормоз", "электромагнит", "brake", "coil", "shoe"],
                ["кран", "кранового", "рдк", "crane", "двигател"],
            ],
        },
    },
    "thread_tap": {
    ...
    "hacksaw": {
        "entity_types": ["hacksaw"],
        "default_branches": ["ножовки"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["ножовк", "hacksaw", "hand saw"]],
        },
    },
    "socket_head_set": {
    ...
    "press_fitting": {
        ...
        "classifier": {
            ...
            "required_any_tokens": [["пресс", "press"], ["фитинг", "fitting", "угол", "тройник", "муфта"]],
        },
    },
    ...
    "milling_cutter": {
        ...
        "classifier": {
            ...
            "negative_patterns": ["фрезер", "ручной", "router", "коронка", "сверло", "диск", "бор-фреза", "бор фреза", "борфрез", "шарош"],
    ...
    "workwear": {
        ...
        "default_branches": [
            ...
            "сигнальные брюки, полукомбинезоны",
            "брюки, полукомбинезоны сварщика",
            "брюки, полукомбинизоны мультизащитные",
            "куртки утепленные",
            "куртки летние",
            "жилеты утепленные",
            "халаты рабочие",
        ...
        "classifier": {
            ...
            "positive_patterns": [
                ...
                "сигнальные брюки",
                "брюки сварщика",
                "полукомбинезон сварщика",
                "мультизащитные брюки",
                "брюки мультизащитные",
            ],
            "negative_patterns": [
                "купальник",
                "маскарад",
            ...
            "required_any_tokens": [["костюм", "suit", "полукомбинез", "брюк", "куртк", "жилет", "халат", "jacket", "overall", "workwear"], ["летн", "утеплен", "рабоч", "сварщ", "сигнальн", "мультизащ", "workwear"]],
        },
    },
    "safety_footwear": {
    ...
    "sandpaper": {
        "entity_types": ["sandpaper"],
        "default_branches": ["бумага шлифовальная"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["бумаг", "наждач", "sandpaper", "abrasive paper"], ["шлиф", "abrasive"]],
        },
    },
    "wire_brush_tool": {
    ...
    "combination_pliers": {
        "entity_types": ["combination_pliers"],
        "default_branches": ["плоскогубцы и пассатижи"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["плоскогуб", "пассатиж", "combination pliers", "lineman pliers"]],
        },
    },
    "tongue_groove_plier": {
        "entity_types": ["tongue_groove_plier"],
        "default_branches": ["переставные клещи"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["клещи", "pliers"], ["переставн", "water pump", "tongue groove", "groove joint"]],
        },
    },
    "crimping_tool": {
    ...
    "lightning_protection": {
        "entity_types": ["lightning_protection"],
        "default_branches": [
            "соединители молниезащиты",
            "аксессуары к устройствам молниезащиты и заземления",
        ],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        ...
        "classifier": {
            "priority": 50,
            "positive_patterns": [
                "соединитель молниезащиты",
                "соединители молниезащиты",
                "аксессуар молниезащиты",
                "аксессуары молниезащиты",
                "клемма заземления молниезащиты",
                "lightning protection connector",
                "lightning clamp",
            ...
            "required_any_tokens": [["молниезащит", "lightning"], ["соединит", "аксессуар", "зажим", "клемм", "connector", "clamp"]],
        },
    },
    ...
    "torx_key": {
        "entity_types": ["torx_key"],
        "default_branches": [
            "ключи имбусовые звездочки (torx)",
            "наборы ключей torx",
        ],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        ...
        "classifier": {
            ...
            "required_any_tokens": [["ключ", "key", "wrench"], ["torx", "звездочк"]],
        },
    },
    "driver_bit_set": {
        "entity_types": ["driver_bit_set"],
        "default_branches": ["биты и наборы бит", "наборы бит"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["бит", "bit"], ["набор", "set"]],
        },
    },
    "phillips_bit": {
        ...
        "classifier": {
            ...
            "required_any_tokens": [["бит", "бита", "bit"], ["крест", "ph", "phillips"]],
        },
    },
    "pozidriv_bit": {
        "entity_types": ["pozidriv_bit"],
        "default_branches": ["биты крест pz (pozidriv)"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["бит", "бита", "bit"], ["pozidriv", "pz"]],
        },
    },
    "hex_bit": {
    ...
    "step_drill": {
        "entity_types": ["step_drill"],
        "default_branches": ["ступенчатые сверла"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["сверл", "drill"], ["ступенч", "step", "conical"]],
        },
    },
    "concrete_hole_saw": {
    ...
    "hole_saw": {
        ...
        "default_branches": ["коронки", "коронки по металлу"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
    ...
    "hose_clamp": {
        ...
        "classifier": {
            ...
            "required_any_tokens": [["хомут", "clamp", "clip"], ["червячн", "ремонтн", "worm", "hose"]],
        },
    },
    "steel_flange": {
        "entity_types": ["steel_flange"],
        "default_branches": ["фланцы стальные плоские"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["фланц", "flange"], ["сталь", "steel", "плоск"]],
        },
    },
    "welding_electrode": {
        "entity_types": ["welding_electrode"],
        "default_branches": ["электроды для сварки"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["электрод", "electrode"], ["свар", "weld", "stick"]],
        },
    },
    "countersink_tool": {
    ...
    "rotary_burr": {
        "entity_types": ["rotary_burr"],
        "default_branches": ["борфрезы и шарошки"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "negative_patterns": ["фрезы для станков", "концевая фреза", "коронка", "сверло", "диск"],
            "required_any_tokens": [["борфрез", "бор фрез", "шарош", "burr"], ["твердосплав", "carbide", "фрез", "rotary"]],
        },
    },
    "sds_chisel": {
    ...
    "terminal_block": {
        ...
        "default_branches": [
            ...
            "рычажковые клеммы смк",
            "клеммные зажимы винтовые (зви)",
            "клеммы заземления на din-рейку",
            "компактные клеммы смк",
            "клеммы строительно-монтажные (смк)",
        ],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
    ...
    "din_rail": {
        "entity_types": ["din_rail"],
        "default_branches": ["din-рейки"],
        "retrieval_mode": "branch_limited",
        "strictness": "semi_strict",
        "audited": True,
        "weak_match_policy": "reject_in_exact",
        "classifier": {
            ...
            "required_any_tokens": [["din", "дин"], ["рейк", "rail"]],
        },
    },
    "wire_ferrule": {
...
DEFAULT_DOMAIN_REGISTRY: Dict[str, Any] = {
    "domains": {
        ...
        "din_rail": {
            "patterns": ["din-рейка", "din рейка", "din rail", "дин рейка"],
            "families": ["din_rail"],
        },
        "electrical_tape": {
        ...
        "hacksaw": {
            "patterns": ["ножовка", "ножовки", "ножовка по металлу", "ножовка по дереву", "hacksaw", "hand saw"],
            "families": ["hacksaw"],
        },
        "bore_gauge": {
        ...
        "steel_flange": {
            "patterns": ["фланцы стальные плоские", "фланец стальной плоский", "steel flange", "flat flange"],
            "families": ["steel_flange"],
        },
        "metal_turning_tool": {
        ...
        "welding_electrode": {
            "patterns": ["электроды для сварки", "электрод сварочный", "сварочный электрод", "welding electrode", "stick electrode"],
            "families": ["welding_electrode"],
        },
        "workwear": {
            "patterns": ["костюм летний", "костюмы летние", "костюм утепленный", "костюмы утепленные", "костюмы сварщика", "костюм сварщика", "сигнальный костюм", "сигнальные костюмы", "полукомбинезон рабочий", "брюки рабочие", "куртка утепленная", "куртки утепленные", "куртка летняя", "куртки летние", "жилет утепленный", "жилеты утепленные", "халат рабочий", "халаты рабочие", "workwear suit", "workwear jacket", "workwear overall"],
            "families": ["workwear"],
        },
        "safety_footwear": {
        ...
        "combination_pliers": {
            "patterns": ["плоскогубцы", "пассатижи", "combination pliers", "lineman pliers"],
            "families": ["combination_pliers"],
        },
        "tongue_groove_plier": {
            "patterns": ["переставные клещи", "клещи переставные", "water pump pliers", "tongue groove pliers", "groove joint pliers"],
            "families": ["tongue_groove_plier"],
        },
        "protective_helmet": {
        ...
        "sandpaper": {
            "patterns": ["бумага шлифовальная", "наждачная бумага", "шлифовальная бумага", "sandpaper", "abrasive paper"],
            "families": ["sandpaper"],
        },
        "wire_brush_tool": {
        ...
        "driver_bit_set": {
            "patterns": ["биты и наборы бит", "наборы бит", "набор бит", "bit set", "driver bit set"],
            "families": ["driver_bit_set"],
        },
        "phillips_bit": {
            "patterns": ["биты крест ph", "бита крест ph", "бита крест", "бита ph", "биты phillips", "phillips bit"],
            "families": ["phillips_bit"],
        },
        "pozidriv_bit": {
            "patterns": ["биты крест pz", "бита крест pz", "бита pz", "pozidriv bit", "pz bit"],
            "families": ["pozidriv_bit"],
        },
        "self_tapping_screw": {
        ...
        "hole_saw": {
            "patterns": ["коронка", "коронки", "кольцевая коронка", "коронка по металлу", "коронки по металлу", "удлинитель для коронок", "hole saw", "bi-metal hole saw", "metal hole saw"],
            "families": ["hole_saw"],
        },
        "countersink_tool": {
        ...
        "rotary_burr": {
            "patterns": ["бор-фреза", "бор фреза", "борфреза", "борфрезы и шарошки", "шарошка", "rotary burr", "carbide burr"],
            "families": ["rotary_burr"],
        },
        "sds_chisel": {
            "patterns": [
                "зубило sds-plus",
...
DEFAULT_AUDIT_SCOPE: Dict[str, Any] = {
    ...
    "family_groups": {
        ...
        "warehouse_cart_part": "warehouse_cart_part",
        "crane_equipment_accessory": "crane_equipment_accessory",
        ...
        "press_fitting": "press_fitting",
        "pnd_compression_fitting": "pnd_compression_fitting",
        "steel_flange": "steel_flange",
        "metal_turning_tool": "metal_turning_tool",
        "welding_electrode": "welding_electrode",
        ...
        "combination_pliers": "combination_pliers",
        "tongue_groove_plier": "tongue_groove_plier",
    ...
    "family_group_labels": {
        ...
        "warehouse_cart_part": "warehouse cart part",
        "crane_equipment_accessory": "crane equipment accessory",
        ...
        "steel_flange": "steel flange",
        "metal_turning_tool": "metal turning tool",
        "welding_electrode": "welding electrode",
        ...
        "tongue_groove_plier": "tongue groove plier",
